    ...
    def predict_step(self, batch: Any, batch_idx: int, dataloader_idx: int = 0, randomly_kill_helix_feature: bool = False, negative_helix_constant: float = 0.1, binder_chain: str = "A", logmd: bool = False, structure: Any = None,
        ...
        try:
            ...
            if self.skip_run_structure:
                # Replace coords with input structure coordinates for scoring
                pred_dict["coords"] = batch["coords"]
            else:
                # Only generated by diffusion model or structure prediction
                pred_dict["coords"] = out["sample_atom_coords"]
            #------ End of Score Only Fix
            if self.confidence_prediction:
